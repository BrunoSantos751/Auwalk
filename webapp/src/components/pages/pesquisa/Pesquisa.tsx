...
export default function Pesquisa() {
    ...
    const carregarEnderecoUsuario = async () => {
        try {
            ...
            const response = await fetch(`https://api.auwalk.com.br/enderecos?idUsuario=${idUsuario}`);
            if (!response.ok) {
                setMostrarFiltroProximidade(false);
                return;
            }
            ...
            if (raioKm && enderecoUsuario) {
                ...
                try {
                    const responseProximos = await fetch(
                        `https://api.auwalk.com.br/enderecos/proximos?latitude=${enderecoUsuario.latitude}&longitude=${enderecoUsuario.longitude}&raioMetros=${raioMetros}`
                    );
                    ...
                    if (responseProximos.ok) {
                        ...
                        const response = await fetch('https://api.auwalk.com.br/search', {
                            method: 'POST',
    ...
    const checkProviderStatus = async () => {
        ...
        try {
            const response = await fetch('https://api.auwalk.com.br/provider/profile/me', {
    ...
    const handleAgendar = async (horario: string, petId: number) => {
        ...
        try {
            ...
            const endpoint = isPasseio ? 'https://api.auwalk.com.br/schedule/walk' : 'https://api.auwalk.com.br/schedule/sitter';
            ...
            await fetch('https://api.auwalk.com.br/chats', {
              method: 'POST',
              headers: {
    ...
    const handleVerPerfil = async (idPrestador: number) => {
        try {
            ...
            const response = await fetch(`https://api.auwalk.com.br/provider/profile?idPrestador=${idPrestador}`);
            if (!response.ok) {
