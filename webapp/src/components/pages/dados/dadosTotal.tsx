  ...
  useEffect(() => {
    const carregarDados = async () => {
      try {
        ...
        const enderecoResponse = await fetch(`http://http://auwalk.us-east-2.elasticbeanstalk.com/enderecos?idUsuario=${idUsuarioToken}`);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const endpoint = idEndereco
        ? `http://http://auwalk.us-east-2.elasticbeanstalk.com/enderecos/${idEndereco}`
        : 'http://http://auwalk.us-east-2.elasticbeanstalk.com/enderecos';
