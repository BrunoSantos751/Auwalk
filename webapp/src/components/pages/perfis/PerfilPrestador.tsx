...
const PerfilPrestador: React.FC = () => {
    ...
    const carregarDadosPrestador = async (idUsuarioParam: number) => {
        try {
            ...
            const perfilResponse = await fetch(`https://api.auwalk.com.br/provider/profile?idUsuario=${idUsuarioParam}`);
            ...
            if (perfilData.success && perfilData.data) {
                ...
                const servicosResponse = await fetch(`https://api.auwalk.com.br/services?idPrestador=${idPrestador}`);
                ...
                const avaliacoesResponse = await fetch(`https://api.auwalk.com.br/avaliacoes-prestador?idUsuario=${idUsuarioParam}`);
                ...
                const mediaResponse = await fetch(`https://api.auwalk.com.br/avaliacoes-prestador/media?idUsuario=${idUsuarioParam}`);
                if (mediaResponse.ok) {
