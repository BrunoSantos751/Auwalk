...
const PerfilPrestador: React.FC = () => {
    ...
    const carregarDadosPrestador = async (idUsuarioParam: number) => {
        try {
            ...
            const perfilResponse = await fetch(`http://localhost:8080/provider/profile?idUsuario=${idUsuarioParam}`);
            ...
            if (perfilData.success && perfilData.data) {
                ...
                const servicosResponse = await fetch(`http://localhost:8080/services?idPrestador=${idPrestador}`);
                ...
                const avaliacoesResponse = await fetch(`http://localhost:8080/avaliacoes-prestador?idUsuario=${idUsuarioParam}`);
                ...
                const mediaResponse = await fetch(`http://localhost:8080/avaliacoes-prestador/media?idUsuario=${idUsuarioParam}`);
                if (mediaResponse.ok) {
