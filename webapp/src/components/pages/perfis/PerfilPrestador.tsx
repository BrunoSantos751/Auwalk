...
const PerfilPrestador: React.FC = () => {
    ...
    const carregarDadosPrestador = async (idUsuarioParam: number) => {
        try {
            ...
            const perfilResponse = await fetch(`https://auwalk-redirect.santosmoraes79.workers.dev/provider/profile?idUsuario=${idUsuarioParam}`);
            ...
            if (perfilData.success && perfilData.data) {
                ...
                const servicosResponse = await fetch(`https://auwalk-redirect.santosmoraes79.workers.dev/services?idPrestador=${idPrestador}`);
                ...
                const avaliacoesResponse = await fetch(`https://auwalk-redirect.santosmoraes79.workers.dev/avaliacoes-prestador?idUsuario=${idUsuarioParam}`);
                ...
                const mediaResponse = await fetch(`https://auwalk-redirect.santosmoraes79.workers.dev/avaliacoes-prestador/media?idUsuario=${idUsuarioParam}`);
                if (mediaResponse.ok) {
