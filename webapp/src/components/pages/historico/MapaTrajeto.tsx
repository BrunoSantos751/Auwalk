    ...
    useEffect(() => {
        const carregarTrajetos = async () => {
            try {
                ...
                const trajetoOriginalResponse = await fetch(`https://api.auwalk.com.br/trajetos?idPasseio=${idPasseio}`);
                ...
                const trajetoSimplificadoResponse = await fetch(`https://api.auwalk.com.br/trajetos/simplificado/${idPasseio}`);
