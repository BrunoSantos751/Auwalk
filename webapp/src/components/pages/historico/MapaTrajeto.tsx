    ...
    useEffect(() => {
        const carregarTrajetos = async () => {
            try {
                ...
                const trajetoOriginalResponse = await fetch(`https://auwalk-redirect.santosmoraes79.workers.dev/trajetos?idPasseio=${idPasseio}`);
                ...
                const trajetoSimplificadoResponse = await fetch(`https://auwalk-redirect.santosmoraes79.workers.dev/trajetos/simplificado/${idPasseio}`);
